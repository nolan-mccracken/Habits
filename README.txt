DAILY POINTS V5.2 - iPhone End-of-Day migration fix
...
V5.2 migration fix:
- Restores the End-of-Day flags for the intended evening confirmation habits on devices that upgraded from older versions.
- Adds missing V5 starter habits (including the three nutrition checks) without deleting existing history, custom habits, rewards, or checkmarks.
- Uses a fresh service-worker cache so iPhone receives the corrected app code.
